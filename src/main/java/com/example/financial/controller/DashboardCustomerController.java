...
@Tag(name = "Dashboard Cliente", description = "Endpoints do dashboard do cliente")
public class DashboardCustomerController {

    @Autowired
    private DashboardService dashboardService;

    @Operation(summary = "Informações dos cards do dashboard", description = "Retorna os dados resumidos para exibição nos cards do dashboard do cliente")
    @ApiResponses({
    ...
    @Operation(summary = "Informações dos charts do dashboard", description = "Retorna os dados dos gráficos do dashboard do cliente")
    @ApiResponses({
